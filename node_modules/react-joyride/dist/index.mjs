...
function getMergedStep(currentStep, props) {
  ...
  floaterProps.styles = deepmerge2(floaterProps.styles ?? {}, mergedStyles.floaterStyles);
  ...
  return {
    ...mergedStep,
    locale: deepmerge2.all([defaultLocale, props.locale ?? {}, mergedStep.locale || {}]),
    floaterProps,
    ...
    if (beaconComponent) {
      ...
      component = /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          ...sharedProps,
          children: [
            /* @__PURE__ */ jsx("span", { style: styles.beaconInner }),
            /* @__PURE__ */ jsx("span", { style: styles.beaconOuter })
          ]
        },
        "JoyrideBeacon"
      );
...
function JoyrideSpotlight({ styles }) {
  return /* @__PURE__ */ jsx2("div", { className: "react-joyride__spotlight", style: styles }, "JoyrideSpotlight");
}
...
var JoyrideOverlay = class extends React2.Component {
  ...
  render() {
    ...
    let spotlight2 = placement !== "center" && showSpotlight && /* @__PURE__ */ jsx3(Spotlight_default, { styles: this.spotlightStyles });
    if (getBrowser() === "safari") {
      const { mixBlendMode, zIndex, ...safarOverlay } = stylesOverlay;
      spotlight2 = /* @__PURE__ */ jsx3("div", { style: { ...safarOverlay }, children: spotlight2 });
...
function JoyrideTooltipContainer(props) {
  ...
  if (continuous) {
    ...
    if (showProgress) {
      output.primary = /* @__PURE__ */ jsxs2("span", { children: [
        output.primary,
        " (",
        index + 1,
        "/",
  ...
  if (!hideBackButton && index > 0) {
    output.back = /* @__PURE__ */ jsx5("button", { "data-test-id": "button-back", style: styles.buttonBack, type: "button", ...backProps, children: back });
  }
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs2("div", { style: styles.tooltipContainer, children: [
          title && /* @__PURE__ */ jsx5("h4", { "aria-label": innerText2(title), style: styles.tooltipTitle, children: title }),
...
var JoyrideStep = class extends React5.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ jsxs3("div", { className: "react-joyride__step", children: [
      /* @__PURE__ */ jsx7(JoyridePortal, { id: "react-joyride-portal", children: /* @__PURE__ */ jsx7(
        JoyrideOverlay,
        {
          ...step,
          debug,
...
var Joyride = class extends React6.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ jsx8("div", { className: "react-joyride", children: output });
  }
};
