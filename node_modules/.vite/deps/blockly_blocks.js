  ...
  "node_modules/blockly/blocks_compressed.js"(exports, module) {
    (function(root, factory) {
      ...
      module$exports$Blockly$libraryBlocks$lists.blocks.lists_create_with = { init: function() {
        ...
        for (a = []; b; )
          b.isInsertionMarker() || a.push(b.valueConnection_), b = b.getNextBlock();
        ...
        this.updateShape_();
        for (b = 0; b < this.itemCount_; b++)
          $.Mutator$$module$build$src$core$mutator.reconnect(a[b], this, "ADD" + b);
      ...
      module$exports$Blockly$libraryBlocks$lists.blocks.lists_getIndex = { init: function() {
        ...
        this.setTooltip(function() {
          ...
          if ("FROM_START" === d || "FROM_END" === d)
            e += "  " + ("FROM_START" === d ? module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_INDEX_FROM_START_TOOLTIP : module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_INDEX_FROM_END_TOOLTIP).replace("%1", b.workspace.options.oneBasedIndex ? "#1" : "#0");
          return e;
        });
      }, mutationToDom: function() {
        const a = $.module$build$src$core$utils$xml.createElement("mutation");
      ...
      module$exports$Blockly$libraryBlocks$lists.blocks.lists_setIndex = { init: function() {
        ...
        this.setTooltip(function() {
          ...
          if ("FROM_START" === d || "FROM_END" === d)
            e += "  " + module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_INDEX_FROM_START_TOOLTIP.replace(
              "%1",
      ...
      var module$contents$Blockly$libraryBlocks$logic_CONTROLS_IF_MUTATOR_MIXIN = {
        ...
        updateShape_: function() {
          ...
          for (a = 1; a <= this.elseifCount_; a++)
            this.appendValueInput("IF" + a).setCheck("Boolean").appendField(module$contents$Blockly$libraryBlocks$logic_Msg.CONTROLS_IF_MSG_ELSEIF), this.appendStatementInput("DO" + a).appendField(module$contents$Blockly$libraryBlocks$logic_Msg.CONTROLS_IF_MSG_THEN);
        ...
        reconnectChildBlocks_: function(a, b, c) {
          for (let d = 1; d <= this.elseifCount_; d++)
            $.Mutator$$module$build$src$core$mutator.reconnect(a[d], this, "IF" + d), $.Mutator$$module$build$src$core$mutator.reconnect(b[d], this, "DO" + d);
      ...
      var module$contents$Blockly$libraryBlocks$loops_CONTROL_FLOW_IN_LOOP_CHECK_MIXIN = { getSurroundLoop: function() {
        let a = this;
        do {
          if (module$exports$Blockly$libraryBlocks$loops.loopTypes.has(a.type))
            return a;
      ...
      var module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_DEF_COMMON = { setStatements_: function(a) {
        ...
        if (null !== a && (a = "TRUE" === a, this.hasStatements_ !== a))
          if (a)
            this.setStatements_(true), $.Mutator$$module$build$src$core$mutator.reconnect(
        ...
        if ("" === c.type) {
          ...
          for (let e = 0; e < this.argumentVarModels_.length; e++)
            this.argumentVarModels_[e].getId() === a && (this.arguments_[e] = b.name, this.argumentVarModels_[e] = b, d = true);
        ...
        let c = false, d;
        for (let e = 0; e < this.argumentVarModels_.length; e++)
          this.argumentVarModels_[e].getId() === a.getId() && (d = this.arguments_[e], this.arguments_[e] = b, c = true);
        ...
        if (this.mutator && this.mutator.isVisible()) {
          ...
          for (let d = 0, e; e = c[d]; d++)
            "procedures_mutatorarg" === e.type && $.module$build$src$core$names.Names.equals(a, e.getFieldValue("NAME")) && e.setFieldValue(b, "NAME");
        }
        ...
        if (!this.isInFlyout) {
          ...
          if (!this.isCollapsed())
            for (b = 0; b < this.argumentVarModels_.length; b++)
              d = { enabled: true }, c = this.argumentVarModels_[b], d.text = module$contents$Blockly$libraryBlocks$procedures_Msg.VARIABLES_SET_CREATE_GET.replace(
                "%1",
                c.name
      ...
      var module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_CALL_COMMON = { getProcedureCall: function() {
        ...
        if (a.join("\n") === this.arguments_.join("\n"))
          ...
          for (a = 0; a < this.arguments_.length; a++)
            d = $.module$build$src$core$variables.getOrCreateVariablePackage(this.workspace, null, this.arguments_[a], ""), this.argumentVarModels_.push(d);
          this.updateShape_();
          if (this.quarkIds_ = b)
            for (b = 0; b < this.arguments_.length; b++)
              a = this.quarkIds_[b], a in this.quarkConnections_ && ($.Mutator$$module$build$src$core$mutator.reconnect(this.quarkConnections_[a], this, "ARG" + b) || delete this.quarkConnections_[a]);
        ...
        if (a = this.getInput("TOPROW"))
          this.arguments_.length ? this.getField("WITH") || (a.appendField(module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_CALL_BEFORE_PARAMS, "WITH"), a.init()) : this.getField("WITH") && a.removeField("WITH");
      }, mutationToDom: function() {
        const a = $.module$build$src$core$utils$xml.createElement("mutation");
        ...
        if (this.workspace && !this.workspace.isFlyout && a.recordUndo)
          if (a.type === $.module$build$src$core$events$events.BLOCK_CREATE && -1 !== a.ids.indexOf(this.id)) {
      ...
      var module$contents$Blockly$libraryBlocks$variables_CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN = { customContextMenu: function(a) {
        if (!this.isInFlyout) {
          if ("variables_get" === this.type) {
            ...
            b = "variables_get", c = module$contents$Blockly$libraryBlocks$variables_Msg.VARIABLES_SET_CREATE_GET;
      ...
      var module$contents$Blockly$libraryBlocks$variablesDynamic_CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN = { customContextMenu: function(a) {
        if (!this.isInFlyout) {
          ...
          if ("variables_get_dynamic" === this.type) {
            ...
            b = "variables_get_dynamic", d = module$contents$Blockly$libraryBlocks$variablesDynamic_Msg.VARIABLES_SET_CREATE_GET;
