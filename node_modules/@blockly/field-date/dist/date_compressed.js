...
*/
'use strict';var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;$jscomp.FORCE_POLYFILL_PROMISE=!1;$jscomp.ENABLE_UNHANDLED_REJECTION_POLYFILL=!0;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){if(a==Array.prototype||a==Object.prototype)return a;a[b]=c.value;return a};
...
$jscomp.propertyToPolyfillSymbol[e],$jscomp.defineProperty(d,e,{configurable:!0,writable:!0,value:b})))};$jscomp.polyfill("String.prototype.trimLeft",function(a){function b(){return this.replace(/^[\s\xa0]+/,"")}return a||b},"es_2019","es3");var COMPILED=!0,goog=goog||{};goog.global=this||self;
...
goog.functions.debounce=function(a,b,c){let d=0;return function(e){goog.global.clearTimeout(d);const f=arguments;d=goog.global.setTimeout(function(){a.apply(c,f)},b)}};goog.functions.throttle=function(a,b,c){let d=0,e=!1,f=[];const g=function(){d=0;e&&(e=!1,h())},h=function(){d=goog.global.setTimeout(g,b);a.apply(c,f)};return function(k){f=arguments;d?e=!0:h()}};
goog.functions.rateLimit=function(a,b,c){let d=0;const e=function(){d=0};return function(f){d||(d=goog.global.setTimeout(e,b),a.apply(c,arguments))}};goog.functions.isFunction=a=>"function"===typeof a;goog.array={};goog.NATIVE_ARRAY_PROTOTYPES=goog.TRUSTED_SITE;const module$contents$goog$array_ASSUME_NATIVE_FUNCTIONS=2012<goog.FEATURESET_YEAR;goog.array.ASSUME_NATIVE_FUNCTIONS=module$contents$goog$array_ASSUME_NATIVE_FUNCTIONS;function module$contents$goog$array_peek(a){return a[a.length-1]}goog.array.peek=module$contents$goog$array_peek;goog.array.last=module$contents$goog$array_peek;
...
goog.dom.TagName.VIDEO="VIDEO";goog.dom.TagName.WBR="WBR";goog.object={};goog.object.forEach=function(a,b,c){for(const d in a)b.call(c,a[d],d,a)};goog.object.filter=function(a,b,c){const d={};for(const e in a)b.call(c,a[e],e,a)&&(d[e]=a[e]);return d};goog.object.map=function(a,b,c){const d={};for(const e in a)d[e]=b.call(c,a[e],e,a);return d};goog.object.some=function(a,b,c){for(const d in a)if(b.call(c,a[d],d,a))return!0;return!1};goog.object.every=function(a,b,c){for(const d in a)if(!b.call(c,a[d],d,a))return!1;return!0};
...
goog.html.SafeStyle.concat=function(a){var b="",c=function(d){Array.isArray(d)?goog.array.forEach(d,c):b+=goog.html.SafeStyle.unwrap(d)};goog.array.forEach(arguments,c);return b?goog.html.SafeStyle.createSafeStyleSecurityPrivateDoNotAccessOrElse(b):goog.html.SafeStyle.EMPTY};const module$contents$goog$html$SafeStyleSheet_CONSTRUCTOR_TOKEN_PRIVATE={};
...
a[d];if(b[e])c.push(b[e]);else if(goog.object.contains(b,e)&&c.pop()!=e)return!1}return 0==c.length}static concat(a){let b="";const c=d=>{Array.isArray(d)?goog.array.forEach(d,c):b+=module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.unwrap(d)};goog.array.forEach(arguments,c);return module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.createSafeStyleSheetSecurityPrivateDoNotAccessOrElse(b)}static fromConstant(a){a=goog.string.Const.unwrap(a);if(0===a.length)return module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.EMPTY;
...
goog.debug.freeze=function(a){return goog.debug.freezeInternal_(a)};goog.events={};const module$contents$goog$events$BrowserFeature_purify=a=>({valueOf:a}).valueOf();
...
[goog.a11y.aria.State.REQUIRED]:!1,[goog.a11y.aria.State.SORT]:"none",[goog.a11y.aria.State.BUSY]:!1,[goog.a11y.aria.State.DISABLED]:!1,[goog.a11y.aria.State.HIDDEN]:!1,[goog.a11y.aria.State.INVALID]:"false"});return goog.a11y.aria.DefaultStateValueMap_};goog.dom.BrowserFeature={};goog.dom.BrowserFeature.ASSUME_NO_OFFSCREEN_CANVAS=!1;goog.dom.BrowserFeature.ASSUME_OFFSCREEN_CANVAS=!1;goog.dom.BrowserFeature.detectOffscreenCanvas_=function(a){try{return!!(new self.OffscreenCanvas(0,0)).getContext(a)}catch(b){}return!1};goog.dom.BrowserFeature.OFFSCREEN_CANVAS_2D=!goog.dom.BrowserFeature.ASSUME_NO_OFFSCREEN_CANVAS&&(goog.dom.BrowserFeature.ASSUME_OFFSCREEN_CANVAS||goog.dom.BrowserFeature.detectOffscreenCanvas_("2d"));
...
*/
Blockly.FieldDate={};
class FieldDate extends Blockly.FieldTextInput{constructor(a,b,c=!1){super(a,b);this.textEditEnabled_=1==c||"true"==c}static fromJson(a){return new this(a.date,void 0,a.textEdit)}static loadLanguage_(){for(const a in goog.i18n)if(a.startsWith("DateTimeSymbols_")){const b=a.substr(16).toLowerCase().replace("_",".");if(goog.getObjectByName(b,Blockly.Msg)){goog.i18n.DateTimeSymbols=goog.i18n[a];break}}}doClassValidation_(a){if(!a)return null;const b=goog.date.Date.fromIsoString(a);return b&&b.toIsoString(!0)==
a?a:null}render_(){super.render_();this.picker_&&this.isTextValid_&&(this.picker_.setDate(goog.date.Date.fromIsoString(this.getValue())),this.updateEditor_())}applyColour(){this.todayColour_=this.sourceBlock_.style.colourPrimary;this.selectedColour_=this.sourceBlock_.style.colourSecondary;this.updateEditor_()}updateEditor_(){if(this.picker_){this.oldTodayElement_&&(this.oldTodayElement_.style.backgroundColor=null,this.oldTodayElement_.style.color=null);var a=this.picker_.getElementByClass("goog-date-picker-today");
if(this.oldTodayElement_=a)a.style.backgroundColor=this.todayColour_,a.style.color="white";this.oldSelectedElement_&&this.oldSelectedElement_!=a&&(this.oldSelectedElement_.style.backgroundColor=null,this.oldSelectedElement_.style.color=null);if(this.oldSelectedElement_=a=this.picker_.getElementByClass("goog-date-picker-selected"))a.style.backgroundColor=this.selectedColour_,a.style.color=this.todayColour_}}showEditor_(a,b){this.textEditEnabled_&&super.showEditor_(a,Blockly.utils.userAgent.MOBILE||
Blockly.utils.userAgent.ANDROID||Blockly.utils.userAgent.IPAD);this.showDropdown_()}showDropdown_(){this.picker_||(this.picker_=this.dropdownCreate_(),this.picker_.render(Blockly.DropDownDiv.getContentDiv()),Blockly.utils.dom.addClass(this.picker_.getElement(),"blocklyDatePicker"),Blockly.DropDownDiv.setColour(this.DROPDOWN_BACKGROUND_COLOUR,this.DROPDOWN_BORDER_COLOUR),Blockly.DropDownDiv.showPositionedByField(this,this.dropdownDispose_.bind(this)),this.updateEditor_())}dropdownCreate_(){FieldDate.loadLanguage_();
const a=new goog.ui.DatePicker;a.setAllowNone(!1);a.setShowWeekNum(!1);a.setUseNarrowWeekdayNames(!0);a.setUseSimpleNavigationMenu(!0);a.setDate(goog.date.DateTime.fromIsoString(this.getValue()));this.changeEventKey_=goog.events.listen(a,goog.ui.DatePicker.Events.CHANGE,this.onDateSelected_,null,this);this.activeMonthEventKey_=goog.events.listen(a,goog.ui.DatePicker.Events.CHANGE_ACTIVE_MONTH,this.updateEditor_,null,this);return a}onClick_(a){this.isTextValid_&&this.showDropdown_()}bindInputEvents_(a){super.bindInputEvents_(a);
this.onClickWrapper_=Blockly.browserEvents.conditionalBind(a,"click",this,this.onClick_,!0)}unbindInputEvents_(){super.unbindInputEvents_();this.onClickWrapper_&&(Blockly.browserEvents.unbind(this.onClickWrapper_),this.onClickWrapper_=null)}dropdownDispose_(){this.picker_=null;goog.events.unlistenByKey(this.changeEventKey_);goog.events.unlistenByKey(this.activeMonthEventKey_)}onDateSelected_(a){this.isDirty_||(a=a.date?a.date.toIsoString(!0):"",this.setEditorValue_(a),Blockly.WidgetDiv.hide(),Blockly.DropDownDiv.hideIfOwner(this))}}
FieldDate.prototype.SERIALIZABLE=!0;FieldDate.prototype.CURSOR="text";FieldDate.prototype.DROPDOWN_BORDER_COLOUR="silver";FieldDate.prototype.DROPDOWN_BACKGROUND_COLOUR="white";FieldDate.prototype.DEFAULT_VALUE=(new goog.date.Date).toIsoString(!0);Blockly.Css.register("\n.blocklyDatePicker,\n.blocklyDatePicker th,\n.blocklyDatePicker td {\n  font: 13px Arial, sans-serif;\n  color: #3c4043;\n}\n\n.blocklyDatePicker th,\n.blocklyDatePicker td {\n  text-align: center;\n  vertical-align: middle;\n}\n\n.blocklyDatePicker .goog-date-picker-wday,\n.blocklyDatePicker .goog-date-picker-date {\n  padding: 6px 6px;\n}\n\n.blocklyDatePicker button {\n  cursor: pointer;\n  padding: 6px 6px;\n  margin: 1px 0;\n  border: 0;\n  color: #3c4043;\n  font-weight: bold;\n  background: transparent;\n}\n\n.blocklyDatePicker .goog-date-picker-previousMonth,\n.blocklyDatePicker .goog-date-picker-nextMonth {\n  height: 24px;\n  width: 24px;\n}\n\n.blocklyDatePicker .goog-date-picker-monthyear {\n  font-weight: bold;\n}\n\n.blocklyDatePicker .goog-date-picker-wday,\n.blocklyDatePicker .goog-date-picker-other-month {\n  color: #70757a;\n  border-radius: 12px;\n}\n\n.blocklyDatePicker button,\n.blocklyDatePicker .goog-date-picker-date {\n  cursor: pointer;\n  background-color: rgb(218, 220, 224, 0);\n  border-radius: 12px;\n  transition: background-color,opacity 100ms linear;\n}\n\n.blocklyDatePicker button:hover,\n.blocklyDatePicker .goog-date-picker-date:hover {\n  background-color: rgb(218, 220, 224, 0.5);\n}\n");
Blockly.fieldRegistry.register("field_date",FieldDate);goog.getMsgOrig=goog.getMsg;goog.getMsg=function(a,b){const c=goog.getMsg.blocklyMsgMap[a];c&&(a=Blockly.Msg[c]);return goog.getMsgOrig(a,b)};goog.getMsg.blocklyMsgMap={Today:"TODAY"};
return FieldDate;
}));


//# sourceMappingURL=date_compressed.js.map
